...
*/
             function loadStatsPage() {
				 ...
				 document.getElementById("losses").innerHTML = loose;
			 }
			...
			purpose: This method will populate the dropdown menu to allow the 
				...
				function loadPlayersPage() {
                  ...
                  for (i = 0; i < players.length; i++) {
				   ...
				   var k = i;
                   aTag.onclick = function() {switchPlayers(k) }	;
...
*/
				 function switchPlayers(playerNum) {
					 ...
					 document.getElementById("player_img").alt="Placeholder for football player image -" + player.name;
